...
export const TypeaheadDropdown = <ItemIdType extends number | string>({
  ...
  const handleDeleteOfLastSelectionOrCloseOrSave: React.KeyboardEventHandler<
    HTMLInputElement
  > = (event) => {
    if (
      ...
      const lastItemKey =
        Object.keys(selected)[Object.keys(selected).length - 1]
  ...
  return (
    <div ref={dropdownRef}>
      ...
      <div
        className="relative mt-1 w-full cursor-default rounded-md border border-gray-100 bg-white py-1 pr-10 text-left shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm"
        ...
        <div className="flex flex-wrap items-center">
          ...
          {allowFiltering && (multiSelect || selectedItems.length === 0) && (
            <input
              ...
              name="search"
              id="search"
              className="inline flex-grow rounded-md border-none focus:border-none focus:outline-none focus:ring-0 sm:text-sm"
