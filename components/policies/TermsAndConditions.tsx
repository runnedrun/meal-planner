const TermsAndConditionsComponent = () => {
  return (
    <div className="prose max-w-none">
      ...
      <ul>
        <li>
          <p>
            ...
            the Company downloaded by You on any electronic device, named Yomuya
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Yomuya.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Yomuya, accessible from{" "}
            <a
              href="https://yomuya.com"
              rel="noreferrer noopener"
              target="_blank"
            >
              https://yomuya.com
      ...
      <ul>
        <li>
          By email: <a href="mailto:legal@yomuya.com">legal@yomuya.com</a>
        </li>
      </ul>
    </div>
  )
...
export const TermsAndConditions = TermsAndConditionsComponent
